...
void COCCSampleAppDoc::OnTestAddDumpedNurbsSurface() {
	...
	cpArray0.SetValue(1, 2, gp_Pnt(-1.77636e-15, 0, 10));
	cpArray0.SetValue(2, 1, gp_Pnt(10, 17.3205, 0));
	cpArray0.SetValue(2, 2, gp_Pnt(-1.77636e-15, -3.07674e-15, 10));
	cpArray0.SetValue(3, 1, gp_Pnt(-5, 8.66025, 0));
	cpArray0.SetValue(3, 2, gp_Pnt(8.88178e-16, -1.53837e-15, 10));
	cpArray0.SetValue(4, 1, gp_Pnt(-20, 2.44929e-15, 0));
	cpArray0.SetValue(4, 2, gp_Pnt(3.55271e-15, -4.35082e-31, 10));
	cpArray0.SetValue(5, 1, gp_Pnt(-5, -8.66025, 0));
	cpArray0.SetValue(5, 2, gp_Pnt(8.88178e-16, 1.53837e-15, 10));
	cpArray0.SetValue(6, 1, gp_Pnt(10, -17.3205, 0));
	cpArray0.SetValue(6, 2, gp_Pnt(-1.77636e-15, 3.07674e-15, 10));
	cpArray0.SetValue(7, 1, gp_Pnt(10, -2.44929e-15, 0));
	cpArray0.SetValue(7, 2, gp_Pnt(-1.77636e-15, 4.35082e-31, 10));
	...
	vKnotsArray0.SetValue(2, 14.1421);
	...
	cpArrayTrimCurve0.SetValue(1, gp_Pnt2d(6.28319, 14.1421));
	cpArrayTrimCurve0.SetValue(2, gp_Pnt2d(0, 14.1421));
	TColStd_Array1OfReal knotsArrayTrimCurve0(1, 2);
	knotsArrayTrimCurve0.SetValue(1, -6.28319);
	knotsArrayTrimCurve0.SetValue(2, -0);
	...
	cpArrayTrimCurve1.SetValue(2, gp_Pnt2d(6.28319, 14.1421));
	TColStd_Array1OfReal knotsArrayTrimCurve1(1, 2);
	knotsArrayTrimCurve1.SetValue(1, 0);
	knotsArrayTrimCurve1.SetValue(2, 14.1421);
	...
	cpArrayTrimCurve3.SetValue(1, gp_Pnt2d(0, 14.1421));
	cpArrayTrimCurve3.SetValue(2, gp_Pnt2d(0, 0));
	TColStd_Array1OfReal knotsArrayTrimCurve3(1, 2);
	knotsArrayTrimCurve3.SetValue(1, -14.1421);
	knotsArrayTrimCurve3.SetValue(2, -0);
	...
	cpArray1.SetValue(1, 1, gp_Pnt(-10, -10, 0));
	cpArray1.SetValue(1, 2, gp_Pnt(-10, 10, 0));
	cpArray1.SetValue(2, 1, gp_Pnt(10, -10, 0));
	cpArray1.SetValue(2, 2, gp_Pnt(10, 10, 0));
	...
	TColgp_Array1OfPnt2d cpArrayTrimCurve4(1, 12);
	TColStd_Array1OfReal wghArrayTrimCurve4(1, 12);
	cpArrayTrimCurve4.SetValue(1, gp_Pnt2d(10, -3.92699));
	cpArrayTrimCurve4.SetValue(2, gp_Pnt2d(10, 3.92699));
	cpArrayTrimCurve4.SetValue(3, gp_Pnt2d(7.9471, 7.54514));
	cpArrayTrimCurve4.SetValue(4, gp_Pnt2d(4.3606, 10));
	cpArrayTrimCurve4.SetValue(5, gp_Pnt2d(-4.3606, 10));
	cpArrayTrimCurve4.SetValue(6, gp_Pnt2d(-7.9471, 7.54514));
	cpArrayTrimCurve4.SetValue(7, gp_Pnt2d(-10, 3.92699));
	cpArrayTrimCurve4.SetValue(8, gp_Pnt2d(-10, -3.92699));
	cpArrayTrimCurve4.SetValue(9, gp_Pnt2d(-7.9471, -7.54514));
	cpArrayTrimCurve4.SetValue(10, gp_Pnt2d(-4.3606, -10));
	cpArrayTrimCurve4.SetValue(11, gp_Pnt2d(4.3606, -10));
	cpArrayTrimCurve4.SetValue(12, gp_Pnt2d(7.9471, -7.54514));
	wghArrayTrimCurve4.SetValue(1, 2);
	wghArrayTrimCurve4.SetValue(2, 2);
	wghArrayTrimCurve4.SetValue(3, 2.00318);
	wghArrayTrimCurve4.SetValue(4, 1.93961);
	wghArrayTrimCurve4.SetValue(5, 1.93961);
	wghArrayTrimCurve4.SetValue(6, 2.00318);
	wghArrayTrimCurve4.SetValue(7, 2);
	wghArrayTrimCurve4.SetValue(8, 2);
	wghArrayTrimCurve4.SetValue(9, 2.00318);
	wghArrayTrimCurve4.SetValue(10, 1.93961);
	wghArrayTrimCurve4.SetValue(11, 1.93961);
	wghArrayTrimCurve4.SetValue(12, 2.00318);
	TColStd_Array1OfReal knotsArrayTrimCurve4(1, 5);
	knotsArrayTrimCurve4.SetValue(1, 0);
	knotsArrayTrimCurve4.SetValue(2, 1.5708);
	knotsArrayTrimCurve4.SetValue(3, 3.14159);
	knotsArrayTrimCurve4.SetValue(4, 4.71239);
	knotsArrayTrimCurve4.SetValue(5, 6.28319);
	TColStd_Array1OfInteger multsArrayTrimCurve4(1, 5);
	multsArrayTrimCurve4.SetValue(1, 3);
	multsArrayTrimCurve4.SetValue(2, 3);
	multsArrayTrimCurve4.SetValue(3, 3);
	multsArrayTrimCurve4.SetValue(4, 3);
	multsArrayTrimCurve4.SetValue(5, 3);
	Handle(Geom2d_BSplineCurve) trimCurve4;
	trimCurve4 = new Geom2d_BSplineCurve(cpArrayTrimCurve4, wghArrayTrimCurve4, knotsArrayTrimCurve4, multsArrayTrimCurve4, 4, Standard_True);
	BRepBuilderAPI_MakeEdge makeEdge4(trimCurve4, nurbsSurf1);
	TopoDS_Edge edge4 = makeEdge4.Edge();
	BRepBuilderAPI_MakeWire wireMaker1;
	wireMaker1.Add(edge4);
	TopoDS_Wire wire1 = wireMaker1.Wire();
	BRepBuilderAPI_MakeFace faceMaker1(nurbsSurf1, wire1, false);
	...
	trimmedNurbsShapeArray.push_back(new AIS_Shape(Nurbsface1));
